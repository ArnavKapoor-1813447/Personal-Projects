%afterwriting the overall code, I decided to add the code that would ask
%the user for their input on how much money they would like to play with
%and added conditionals to output different responses based on input. I
%directly coded this in here to check functionality faster with loop as it
%wasn't comoplex code
clc;
clear all
